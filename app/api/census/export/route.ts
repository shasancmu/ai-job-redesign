...
const COLS = ["id", "created_at", "campaign_code", "wave", "name", "address", "lat", "lng", "country", "admin1", "locality", "naics", "naics_label", "isic", "isic_label", "classify_conf", "employees_band", "revenue_band", "founded_year", "multi_site", "customer_type", "ownership", "wms_overall", "mode"];
