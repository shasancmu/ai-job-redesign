...
- case: an interactive, decision-first CASE STUDY built from the materials — a real situation and protagonist, evidence with drill-downs and cited sources, a decision the learner must commit under uncertainty, then a reveal of what happened. Best for: replacing a static teaching case with a living one grounded in the uploaded documents (a real company, a market episode, a concrete decision the materials describe).
