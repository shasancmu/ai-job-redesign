...
export default async function BenchmarkStudio() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-8">
      ...
      <h1 className="text-3xl text-ink">Benchmarks</h1>
      <p className="mt-1 max-w-2xl text-slate2">A timed, scored "you vs. AI" test. Write the questions and answer key, or let the copilot; learners are scored server-side.</p>
      ...
      <Link href="/studio/benchmark/start" className="group mt-6 block rounded-2xl border border-ai/30 bg-gradient-to-br from-white to-mist/40 p-5 transition hover:shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-lg font-bold text-ink group-hover:text-ai">Describe your benchmark, and build it</div>
      ...
      {(mine || []).length > 0 && (
        <div className="mt-8">
          <div className="text-xs font-semibold uppercase tracking-wide text-slate-400">Your benchmarks</div>
