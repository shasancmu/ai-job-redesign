...
const BLANK: any = { slug: "", name: "New news module", emoji: "🗞️", topic: "", framework: "", frameworkLogic: "", fields: [{ key: "f1", label: "", hint: "" }, { key: "f2", label: "", hint: "" }], verdict: { label: "", options: [] }, grading: "" };
...
export default async function EditNews({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-8">
      ...
      <h1 className="text-2xl font-bold text-ink">{isNew ? "New news module" : `Edit: ${spec.name || params.slug}`}</h1>
