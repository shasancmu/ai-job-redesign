...
export default async function StudioPage() {
  ...
  const cards = [
    ...
    { show: canBuild, key: "guide", icon: "📘", title: "How to create a module", desc: "A short guide: what modules are, the shapes to choose from, and the three ways to build and publish one.", href: "/studio/guide", tour: "New to this? A five-minute read on what modules are, the shapes to choose from, and the three ways to build one. Start here." },
    ...
    { show: canBuild, key: "classes", icon: "🏫", title: "Classes", desc: "A department or course that owns a module set. Its cohorts (sections/sessions) inherit those modules, so you set them once and reuse.", href: "/facilitator/classes", tour: "A class is a department or course. Give it a module set once, and every cohort under it inherits those modules." },
