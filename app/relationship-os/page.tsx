...
const LENSES = [
  ...
  { icon: "💬", title: "Relationship science", body: "A tie strengthens with recency, frequency, and reciprocity. It decays in silence. Catch a relationship while it's cooling, when a small deposit still saves it." },
