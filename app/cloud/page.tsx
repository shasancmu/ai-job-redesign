...
// PUBLIC, no sign-in: type the code from the screen to join a live word cloud.
export default function CloudEntry() {
  ...
  function go(e: React.FormEvent) {
    ...
    if (c.length >= 4) router.push(`/cloud/${c}`);
  }
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-10">
      ...
      <div className="card p-7">
        <h1 className="text-xl font-bold text-ink">Join the word cloud</h1>
