...
export default async function AdminPage() {
  ...
  const platform = [
    ...
    { icon: "🧪", title: "A/B testing", desc: "Run and adopt experiments on your AI interviews, with an autopilot that runs the loop for you.", href: "/admin/experiments" },
    { icon: "💬", title: "Conversations", desc: "Every conversation across every engine (both sides, turn by turn) and the leading signals by intervention. The data spine.", href: "/admin/conversations" },
    { icon: "📈", title: "Impact vs counterfactual", desc: "Conversation quality under the adaptive loop minus a frozen holdout, over time. The causal read on whether the platform is learning.", href: "/admin/impact" },
    { icon: "🔬", title: "Which intervention, and why", desc: "The de-biased ledger of what worked, the mediation decomposition of how, and a transcript-level read of the mechanism.", href: "/admin/interventions" },
    { icon: "🎓", title: "Studies", desc: "Cohort-level field experiments: cohorts frozen to conditions or waves, and the causal effect on L2 competence at the unit a customer deploys.", href: "/admin/studies" },
    { icon: "🎯", title: "L2 calibration", desc: "Does the AI competence score agree with human experts? Rate runs blind; read ICC, correlation, and bias against the human ceiling.", href: "/admin/calibration" },
