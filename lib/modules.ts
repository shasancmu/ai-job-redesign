...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    tagline: "Pressure-test an initiative against the 4 A's and find the one fix most likely to get it executing.",
    description:
  ...
  },
  {
    ...
    tagline: "An AI coach interviews you about this year's real wins, then hands back the exact résumé changes to make.",
    description:
...
export const CATEGORIES: { key: CategoryKey; title: string; blurb: string; chip: string; dot: string }[] = [
  ...
  { key: "research", title: "Research foundations", blurb: "Frame, structure, and argue a research paper, and read your regressions as ideas. The core craft, from Sharique Hasan's “Research, Strategy.”", chip: "bg-sage-soft text-sage", dot: "#3F7A52" },
  { key: "craft", title: "The research craft", blurb: "The hands-on tools of doing research well: reading your data, clean tables and figures, credible identification, a positioned literature review, and a sharp theory section.", chip: "bg-sky-soft text-sky", dot: "#4E79C9" },
  { key: "publish", title: "Get published & run a lab", blurb: "The last mile of scholarship: see your paper through reviewers' eyes, plan the R&R, pick the journal, and design the research system and team behind it.", chip: "bg-sage-soft text-sage", dot: "#3F7A52" },
...
const CATEGORY_OF: Record<string, CategoryKey> = {
  ...
  "find-superpower": "career",
  "refresh-resume": "career",
  "refresh-resume-voice": "career",
  "jd-x-ray": "redesign",
  ...
  "find-problem": "opportunity",
  "find-org-problems": "opportunity",
  "find-problem-voice": "opportunity",
  "find-org-problems-voice": "opportunity",
  "business-consult": "business",
  "voice-consult": "business",
  "ai-board": "strategy",
  "customer-empathy": "business",
  "business-myopia": "business",
  "career-myopia": "career",
  ...
  "regression-tables": "craft",
  "research-graphs": "craft",
  "literature-reviews": "craft",
  "data-moat": "craft",
  "data-strategy": "craft",
  ...
  "journal-fit": "publish",
  "theory-section": "craft",
  "abstract-title": "craft",
  "research-system": "publish",
  "research-team": "publish",
  "what-is-a-phd": "phd",
...
export const INTENTS: { key: IntentKey; emoji: string; label: string; blurb: string; cats: CategoryKey[] }[] = [
  { key: "ai-work", emoji: "🤖", label: "Work smarter with AI", blurb: "Redesign your job or a workflow, grow your career, and see what only a human can do.", cats: ["redesign", "career", "foundations", "governance"] },
...
const PILLS_OF: Record<string, PillKey[]> = {
  ...
  "nearest-expert": ["deeptech", "innovation", "entrepreneurship"],
  "science-radar": ["deeptech", "strategy", "innovation"],
  "science-intel": ["deeptech", "strategy", "innovation", "ai"],
