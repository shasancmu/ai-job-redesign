...
export const LIBRARY_TEMPLATES = [
  { id: "the-diagnosis", name: "Root-cause analysis", emoji: "🩺", domain: "Ops · root-cause", whenToUse: "Symptoms are reported but the cause is hidden and the informant guesses wrong. Medicine, incidents, quality, org dysfunction.", make: diagnosisSpec },
  { id: "the-diligence", name: "Due diligence", emoji: "🔬", domain: "Investing · go / no-go", whenToUse: "Decide invest-or-pass when the other side spins the weak spots but won't lie. VC, procurement, M&A, grant review.", make: diligenceSpec },
  { id: "the-investigation", name: "Workplace investigation", emoji: "🕵️", domain: "Management · what happened", whenToUse: "Establish the facts from someone with a stake in the story. HR complaints, incident reviews, journalism, compliance.", make: investigationSpec },
  { id: "the-discovery", name: "Discovery calls", emoji: "🧭", domain: "Consulting · real problem", whenToUse: "The client arrives sure of the solution; find the real problem first. Consulting, product, sales discovery, UX research.", make: discoverySpec },
  { id: "the-screening", name: "Screening interviews", emoji: "👔", domain: "Hiring · assess a person", whenToUse: "See past a polished self-presentation to the real strength or risk. Interviews, admissions, casting, credit.", make: screeningSpec },
  { id: "the-negotiation", name: "Negotiating an offer", emoji: "🤝", domain: "Negotiation · find the give", whenToUse: "Discover where a counterpart actually has room before you ask for the wrong thing. Salary, procurement, partnerships, disputes.", make: negotiationSpec },
] as const;
