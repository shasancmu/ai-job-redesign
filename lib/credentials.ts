...
export const BUNDLES: Bundle[] = [
  ...
  },
  {
    ...
    line: "Learned the craft of social science, then framed, argued, and tested a paper.",
    core: ["research-good", "research-idea", "research-paper", "research-argument", "research-data", "research-publish"],
    electives: [
      "read-the-interaction", "good-research", "understand-a-paper",
      "what-is-a-paper", "publication-pipeline", "theory-section", "data-moat", "data-strategy", "identification",
      ...
      "research-system", "research-team", "strategy-experiment",
    ],
    electivesNeeded: 3,
    skills: ["Research Design", "Academic Writing", "Causal Inference", "Scholarly Communication", "Scholarly Publishing"],
  },
  {
    key: "phd-path",
  ...
  {
    key: "science-commercialization",
    name: "Science Commercialization",
    line: "Turned an invention into a commercial asset — scored, positioned, and licensed.",
    core: ["score-my-invention", "commercialization-scorecard"],
    electives: ["rank-disclosures", "licensing-brief", "defense-impact", "impact-optimizer", "explain-ai", "position-my-research", "deeptech-canvas"],
    electivesNeeded: 2,
    skills: ["Technology Commercialization", "Tech Transfer", "IP Strategy", "Research Impact"],
  },
  {
    key: "deeptech-scout",
    name: "Deep-Tech Scouting & Intelligence",
    line: "Mapped the science frontier and sourced deals — from nearest expert to spin-out.",
    core: ["nearest-expert", "science-radar"],
    electives: ["technology-landscape", "science-intel", "field-trajectory", "domain-brief", "find-collaborators", "find-a-cofounder", "diligence-the-science", "deep-tech-deal-sourcing"],
    electivesNeeded: 2,
    skills: ["Technology Scouting", "Competitive Intelligence", "Deal Sourcing", "Technical Due Diligence"],
  },
  {
    key: "decision-uncertainty",
    name: "Decision-Making Under Uncertainty",
    line: "Reasoned to a decision against a hidden, adversarial truth — and was scored on it.",
    core: ["earnings-call", "star-hire"],
    electives: ["incentive-lab", "hot-seat", "regression-detective"],
    electivesNeeded: 1,
    skills: ["Analytical Judgment", "Decision-Making Under Uncertainty", "Critical Thinking", "Evidence Evaluation"],
  },
  {
    key: "ai-literacy",
    name: "How AI Works",
...
const CRED_META: Record<string, CredMeta> = {
  ...
  // Science commercialization (TTO)
  "commercialization-scorecard": { name: "University Commercialization Scorecard", skills: ["Technology Commercialization", "Tech Transfer", "Research Impact"] },
  "impact-optimizer": { name: "Research Impact Optimization", skills: ["Research Impact", "Scholarly Communication", "Grant Strategy"] },
  "explain-ai": { name: "Plain-Language Science Translation", skills: ["Science Communication", "Research Impact"] },
  // Deep-tech scouting & intelligence
  "nearest-expert": { name: "Expert Identification", skills: ["Technology Scouting", "Expert Search", "Networking"] },
  "science-radar": { name: "Scientific Frontier Scouting", skills: ["Technology Scouting", "Competitive Intelligence", "R&D Strategy"] },
  "science-intel": { name: "Science Intelligence & Talent Mapping", skills: ["Competitive Intelligence", "Talent Mapping", "Technology Scouting"] },
  "technology-landscape": { name: "Technology Landscape Analysis", skills: ["Technology Scouting", "Competitive Intelligence", "Market Analysis"] },
  "field-trajectory": { name: "Research Field Trajectory Analysis", skills: ["Technology Forecasting", "Competitive Intelligence", "Research Strategy"] },
  "find-a-cofounder": { name: "Technical Co-Founder Search", skills: ["Founder Matching", "Venture Building", "Networking"] },
  "diligence-the-science": { name: "Scientific Due Diligence", skills: ["Technical Due Diligence", "Research Evaluation", "Investment Analysis"] },
  "deep-tech-deal-sourcing": { name: "Deep-Tech Deal Sourcing", skills: ["Deal Sourcing", "Venture Scouting", "Technology Scouting"] },
  // Decision-making under uncertainty (advanced sims)
  "earnings-call": { name: "Forensic Financial Questioning", skills: ["Financial Analysis", "Critical Questioning", "Due Diligence"] },
  "star-hire": { name: "Talent Evaluation Under Uncertainty", skills: ["Talent Assessment", "Interviewing", "Human Capital Analysis"] },
  "incentive-lab": { name: "Incentive & Mechanism Design", skills: ["Incentive Design", "Mechanism Design", "Systems Thinking"] },
  "hot-seat": { name: "Decision-Making Under Pressure", skills: ["Executive Communication", "Critical Thinking", "Composure"] },
  "regression-detective": { name: "Applied Regression Analysis", skills: ["Regression Analysis", "Statistical Reasoning", "Causal Inference"] },
  "strategy-experiment": { name: "Strategy Experiment Design", skills: ["Experimentation", "Strategic Planning", "Validation"] },
  "research-good": { name: "Research Quality: Foundations", skills: ["Research Design", "Scholarly Judgment"] },
  "research-idea": { name: "Research Ideas & Interaction Effects", skills: ["Research Design", "Causal Reasoning"] },
  "research-paper": { name: "Academic Paper Structure", skills: ["Academic Writing", "Scholarly Communication"] },
  "research-argument": { name: "Research Argumentation", skills: ["Academic Writing", "Persuasive Communication"] },
  "research-data": { name: "Causal Inference: Foundations", skills: ["Causal Inference", "Econometrics", "Research Design"] },
  "research-publish": { name: "Publishing & Presenting Research", skills: ["Scholarly Publishing", "Research Communication"] },
