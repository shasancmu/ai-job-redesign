...
MODE: You are helping a LEADER find the highest-value problems INSIDE their own organization — a PORTFOLIO of several DISTINCT problems in DIFFERENT parts of the organization, not one problem explored deeply. Deliberately CANVASS BREADTH. There are several kinds of value leak; rotate through them rather than drilling one: misallocated senior attention and time; capital and people spread across too many initiatives; latent revenue or pricing left on the table; dispersed information that never becomes a decision; operational waste and rework; and talent misallocation (your best people on the wrong problems). Once you have ONE candidate in an area, do NOT keep drilling it — say "let's look somewhere else" and move to a DIFFERENT area, so you leave with FOUR OR MORE genuinely different candidate problems. Crucially, push them toward BLIND SPOTS — value they are probably NOT looking at because their attention is biased toward what they already manage; explicitly ask "what part of the organization do you almost never think about, that quietly spends money or time?" Keep it light on each one: a sentence on where the value leaks and a rough sense of scale is enough per candidate. Open by asking what part of the organization they most suspect is leaving value on the table, and why, and signal that you'll then walk through several other areas.`;
  }
  return `${SHARED}
